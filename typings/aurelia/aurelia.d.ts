...
declare module "aurelia-router" {
  import * as aureliadependencyinjection  from "aurelia-dependency-injection";
  import * as aureliahistory from "aurelia-history";
...
declare module "aurelia-http-client" {
  ...
  class HttpClient {
    ...
    jsonp(url: string): Promise<IJsonpResponse>;
    get(uri: string): Promise<any>;
    put(uri: string, content: any, replacer: any): Promise<any>;
    patch(uri: string, content: any, replacer?: any): Promise<any>;
    post(uri: string, content: any, replacer?: any): Promise<any>;
...
declare module "zewa666/aurelia-i18next"{
  class I18N{
